...
def parse_vhosts_resv(s):
    ...
    try:
        ...
        pass
    vhosts = vhosts.split(b'\x52\x02\x6d')[1:]
    return [x.split(b'\x68\x02\x52')[0][4:].decode('ascii') for x in vhosts]
...
if args.mode == 'vhosts':
    ...
    for vhost in parse_vhosts_resv(sock):
        print(vhost)
